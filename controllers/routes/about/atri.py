...
default_state = json.loads('{"chart1":{"styles":{"width":"","height":"","minWidth":"","minHeight":"","maxWidth":"","maxHeight":"","overflow":""},"custom":{"cartesianGrid":{"show":false,"strokeDasharray":""},"data":[],"xAxis":{"show":false,"key":""},"yAxis":{"show":false},"toolTip":{"show":false},"legend":{"show":false},"stacked":false,"options":{}}}}')
...
class Atri:
	...
	@property
	def chart1(self):
		self._getter_access_tracker["chart1"] = {}
		return self._chart1
	@chart1.setter
	def chart1(self, new_state):
		self._setter_access_tracker["chart1"] = {}
		global default_state
		self._chart1 = BarChart(new_state, default_state["chart1"])
