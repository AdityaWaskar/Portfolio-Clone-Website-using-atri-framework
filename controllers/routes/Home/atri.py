...
class Atri:
	...
	@property
	def navRight(self):
		self._getter_access_tracker["navRight"] = {}
		return self._navRight
	@navRight.setter
	def navRight(self, new_state):
		self._setter_access_tracker["navRight"] = {}
		global default_state
		self._navRight = Flex(new_state, default_state["navRight"])
